...
int Dissassemble8080p(vector<uint8_t>& buffer, int pc)
{
  ...
  case 0x39:
    ...
    break;
  case 0x3a:
    printf("LDA    A,#$%02x%02x", buffer[pc + 2], buffer[pc + 1]);
    opbytes = 3;
    break;
  case 0x3b:
    printf("DCX    SP");
  ...
  case 0xe1:
    ...
    break;
  case 0xe2:
    printf("JNO    $%02x%02x", buffer[pc + 2], buffer[pc + 1]);
    opbytes = 3;
    break;
  case 0xe3:
    printf("XTHL");
